<script>
  ...
  <main>
    <div id="title-block">
      <p id="hi-text">Satire</p>
      <p id="name-text">Vassar</p>
      <p id="sub-name-text" style="backdrop-filter: blur({$blur}px);">
       I got an idea for a dumb joke, got my friend to act, and now it's a reality. </p>
    </div>
  
    <iframe title = "video" class="mounted-image" src="https://www.youtube.com/embed/JzvUG1MI-m4" frameborder="0" allowfullscreen></iframe>
